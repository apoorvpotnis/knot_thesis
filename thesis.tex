...
\newcommand{\KPA}{%
	\KP{\filldraw[fill=none, thick] circle (0.3);}%
}
\newcommand{\KPB}{%
	\KP{
		\draw[thick] (-0.3,0.3) -- (0.3,-0.3);
		\draw[thick] (-0.3,-0.3) -- (-0.05,-0.05);
		\draw[thick] (0.05,0.05) -- (0.3,0.3);
	}%
}
\newcommand{\KPC}{%
	\KP{
...
\newcommand{\KPD}{%
	\KP{%
		\draw[thick] (-0.3,0.3) .. controls (0,-0.05) .. (0.3,0.3);
		\draw[thick] (-0.3,-0.3) .. controls (0,0.05) .. (0.3,-0.3);
	}%
}
\newcommand{\KPE}{%
	\KP{%
		\draw[thick] (-0.3,-0.3) .. controls (0.05,0) .. (-0.3,0.3);
		\draw[thick] (0.3,-0.3) .. controls (-0.05,0) .. (0.3,0.3);
	}%
}
\newcommand{\KPF}{%
	\KP{
		\draw[-{Straight Barb[angle'=85, length=2.15]}, thick] (-0.3,0.3) -- (0.3,-0.3);
		\draw[thick] (-0.3,-0.3) -- (-0.05,-0.05);
		\draw[-{Straight Barb[angle'=85, length=2.15]}, thick] (0.05,0.05) -- (0.3,0.3);
	}%
}
\newcommand{\KPG}{%
	\KP{
...
\newcommand{\KPH}{%
	\KP{%
		\draw[-{Straight Barb[angle'=85, length=2.15]}, thick] (-0.3,0.3) .. controls (0,-0.05) .. (0.3,0.3);
		\draw[-{Straight Barb[angle'=85, length=2.15]}, thick] (-0.3,-0.3) .. controls (0,0.05) .. (0.3,-0.3);
	}%
}
\newcommand{\KPI}{%
...
\newcommand{\KPJ}{%
	\KP{%
		\draw[-{Straight Barb[angle'=85, length=2.15]}, thick] (-0.3,-0.3) .. controls (0.05,0) .. (-0.3,0.3);
		\draw[-{Straight Barb[angle'=85, length=2.15]}, thick] (0.3,-0.3) .. controls (-0.05,0) .. (0.3,0.3);
	}%
}
\newcommand{\KPK}{%
...
\newcommand{\KPL}{%
	\kern -0.06em\KPX{\filldraw[fill=none, thick, decoration={markings, mark=at position 0.25 with {\arrow[xshift=1.5, yshift=0.1\pgflinewidth]{<}}}, postaction={decorate}] circle (0.3);}%
}
...
\newcommand{\KPSM}{
	\KPS{
		\begin{knot}[consider self intersections=true, ignore endpoint intersections=false,%<- long compilation time, so two paths
			...
			\strand[thick] (0, 0)  .. controls  +(3, -1) and +(-3,-1) .. (1,0);
		\end{knot}
	}
}

\newcommand{\KPSA}{%
	\kern -0.07em\KPS{\filldraw[fill=none, thick] circle (0.3);}%
}
\newcommand{\KPSB}{%
	\KPS{
		\draw[thick] (-0.3,0.3) -- (0.3,-0.3);
		\draw[thick] (-0.3,-0.3) -- (-0.08,-0.08);
		\draw[thick] (0.08,0.08) -- (0.3,0.3);
	}%
}
\newcommand{\KPSC}{%
	\KPS{
...
\newcommand{\KPSD}{%
	\KPS{%
		\draw[thick] (-0.3,0.3) .. controls (0,0) .. (0.3,0.3);
		\draw[thick] (-0.3,-0.3) .. controls (0,0) .. (0.3,-0.3);
	}%
}
\newcommand{\KPSE}{%
...
\newcommand{\KPSF}{%
	\KPS{
		\draw[-{Straight Barb[angle'=85, length=1.8]}, thick] (-0.3,0.3) -- (0.3,-0.3);
		\draw[thick] (-0.3,-0.3) -- (-0.08,-0.08);
		\draw[-{Straight Barb[angle'=85, length=1.8]}, thick] (0.08,0.08) -- (0.3,0.3);
	}%
}
\newcommand{\KPSG}{%
	\KPS{
...
\newcommand{\KPSH}{%
	\KPS{%
		\draw[-{Straight Barb[angle'=85, length=1.8]}, thick] (-0.3,0.3) .. controls (0,-0.0) .. (0.3,0.3);
		\draw[-{Straight Barb[angle'=85, length=1.8]}, thick] (-0.3,-0.3) .. controls (0,0.0) .. (0.3,-0.3);
	}%
}
\newcommand{\KPSI}{%
...
\newcommand{\KPSL}{%
	\kern -0.06em\KPSS{\filldraw[fill=none, thick, decoration={markings, mark=at position 0.25 with {\arrow[xshift=1.5, yshift=0.1\pgflinewidth]{<}}}, postaction={decorate}] circle (0.3);}%
}

\newcommand{\KPSX}{%
	\KPS{
		\draw[-{Straight Barb[angle'=85, length=2.15]}, thick] (-0.3,0) -- (0.3,0);
	}%
}

\newcommand{\KPSY}{%
	\begin{tikzpicture}[baseline=-\dimexpr\fontdimen22\textfont2\relax, scale=0.45]
		\draw[thick] circle (0.3);
	\end{tikzpicture}%
}
