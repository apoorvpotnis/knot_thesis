...
\newcommand{\KPintersection}{
	\KP{
		\begin{knot}[clip width = 6, ignore endpoint intersections = false, looseness = 1.2]
...
\newcommand{\Bthirty}{\Bigl\langle\hspace{-3pt}\vcenter{\hbox{\KPthirty}}\hspace{-3pt}\Bigr\rangle}
