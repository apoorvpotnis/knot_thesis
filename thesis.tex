...
\newcommand{\plusoneo}{
	\KP{
		\begin{knot}[rotate=-90, scale=0.3, clip width=7, ignore endpoint intersections=false, consider self intersections=true, looseness=1.6]
...
\newcommand{\minusoneu}{
	\KP{
		\begin{knot}[rotate=180, scale=0.3, clip width=7, ignore endpoint intersections=false, consider self intersections=true, looseness=1.6, flip crossing=2]
			\strand[line width=0.6pt] (-1,1) to[out=-90,in=-90] (0.5,0) to [out=90,in=90] (-1,-1);
		\end{knot}
		% 		\draw[scale=0.3, line width=0.6pt, <-, looseness=1.6, rotate=-90] (-1,1.2) -- (-1,1) to[out=-90,in=-90] (0.5,0);
	}\hspace{-6pt}
