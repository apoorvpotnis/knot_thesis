...
\newcommand{\KPthirtyonetwo}{
	\KP{
		\begin{knot}[consider self intersections = true, clip width = 5, ignore endpoint intersections=false]
			\strand[scale=0.6, line width=0.6pt, looseness=1.4] (0,0) to [out=0,in=180] (0.8,1) to [out=0,in=180] (1,1);
			\strand[scale=0.6, line width=0.6pt, looseness=1.4] (0,1) to [out=0,in=180] (0.2,1) to [out=0,in=180] (1,0);
		\end{knot}
	}
}
