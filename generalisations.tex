...
\begin{exmp}
	Using the skein relation, we have that \[\frac{1}{t} \V\left(\hspace{-10pt}\KPfigureeight\right) - t\V\Cfigureeightf = \left(\sqrt{t} - \frac{1}{\sqrt{t}}\right) \V\left(\KPL \,\,\KPL\right).\]
\end{exmp}
