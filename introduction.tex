...
\begin{proof}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[scale=1.4]
            ...
            \draw[black, dashed, line width=0.7pt] (2,1.5) -- (0,1.5) node[anchor=east, black]{\(\phi_t(a)\)};
            \draw[black, dashed, line width=0.7pt] (2,2.5) -- (0,2.5) node[anchor=east, black]{\(\phi_t(b)\)};
