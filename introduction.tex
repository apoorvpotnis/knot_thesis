...
\begin{figure}
    ...
    \begin{tikzpicture}[scale=0.3]
        \begin{knot}[clip width = 5, consider self intersections = true, ignore endpoint intersections = false, use Hobby shortcut, postaction=show curve controls]
            \strand[ultra thick, red] (0,0)
            to (6,0)
            to [out=0, in=135] (10,-1)
            to [out=-45, in=180] (14, -3)
            to [out=0, in=-90] (18,0)
            to [out=90, in=0] (14,3)
            to [out=180, in=45] (11,1)
            to [out=-135, in=0] (-2,-3);
%             to [out=-60, in=180] (7,-2)
%             to [out=0, in=270] (9,0)
%             to [out=90, in=0] (7,2)
%             to [out=180, in=60] (5,1)
%             to 9;
%             \strand[ultra thick, red] (-5,0) .. (-1,0) .. (0,0) .. (1,0) .. (2,0) .. (3,-1) .. (4,-2) .. (5,0) .. (4,2) .. (3,1) .. (2,-1) .. (1,-2) .. (0,0) .. (1,1) .. (2,2) .. (3,1) .. (4,0) .. (5,0) .. (6,0);
%             \flipcrossings{1, 2}
