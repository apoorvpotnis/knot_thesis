    ...
    \subcaptionbox{A knot with closed ends}{
        \begin{tikzpicture}[scale=0.2]
            \begin{knot}[clip width = 8, consider self intersections = true, ignore endpoint intersections = false, use Hobby shortcut]
                ...
                to [out=90, in=180] (9,4)
                to [out=0, in=180] (21,0)
                to (27,0) to (27,-6) to (0,-6);
                \flipcrossings{4,5,7,8,9,11,12}
            \end{knot}
            \draw[thick, red] (1,-6) -- (0,-6) -- (0,0) -- (1,0);
        \end{tikzpicture}}
                ...
                \end{scope}
                    \begin{scope}[xshift=45cm, scale=0.2]
                        \begin{knot}[clip radius =3pt, clip width = 1.7, consider self intersections = true, ignore endpoint intersections = false, use Hobby shortcut]
                            ...
                            to [out=0, in=180] (21,0)
                            to (22,0);
                            \strand [thick, red, only when rendering/.style={densely dotted}] (22,0) to (48,0);
                            \flipcrossings{1,2,4,5,6,7,8,9}
                        \end{knot}
                    \end{scope}
        \draw[thick, red] (1,0) to (0,0) to (0,-6) to (55,-6) to (55,0) to (53,0);
        \node (p) at (53,1.5) {\(p\)};
...
\begin{proof}
    \begin{figure}
        ...
        \subcaptionbox{\(i_0 (K)\)}{
            \begin{tikzpicture}[scale=0.2]
                ...
                \draw[dashed, line width=0.6pt] (2,-1) to (2,1) to (-1,1) to (-1,-7) to (28,-7) to (28,1) to (25,1) to (25,-1) to (26,-1) to (26,-5) to (1,-5) to (1,-1) to (2,-1);
                \node at (26.4,2.5) {\(U_p\)};
            \end{tikzpicture}}
        \subcaptionbox{\(i_{0.3} (K)\)}{
            \begin{tikzpicture}[scale=0.2]
                \begin{scope}[xshift=4cm, scale=0.7]
                    ...
                    \end{knot}
                \end{scope}
                \draw[thick, red] (22,0) to (27,0) to (27,-6) to (0,-6) -- (1,-6) -- (0,-6) -- (0,0) -- (5,0);
                \filldraw[black] (13.5,-6) circle (5pt) node[anchor=north, yshift=-0.3cm]{\(p\)};
                \draw[dashed, line width=0.6pt] (2,-1) to (2,1) to (-1,1) to (-1,-7) to (28,-7) to (28,1) to (25,1) to (25,-1) to (26,-1) to (26,-5) to (1,-5) to (1,-1) to (2,-1);
                \node at (26.4,2.5) {\(U_p\)};
            \end{tikzpicture}}
        \subcaptionbox{\(i_{0.6} (K)\)}{
            \begin{tikzpicture}[scale=0.2]
                \begin{scope}[xshift=8cm, scale=0.4]
                    ...
                    \end{knot}
                \end{scope}
                \draw[thick, red] (19,0) to (27,0) to (27,-6) to (0,-6) -- (1,-6) -- (0,-6) -- (0,0) -- (8.1,0);
                \filldraw[black] (13.5,-6) circle (5pt) node[anchor=north, yshift=-0.3cm]{\(p\)};
                \draw[dashed, line width=0.6pt] (2,-1) to (2,1) to (-1,1) to (-1,-7) to (28,-7) to (28,1) to (25,1) to (25,-1) to (26,-1) to (26,-5) to (1,-5) to (1,-1) to (2,-1);
                \node at (26.4,2.5) {\(U_p\)};
            \end{tikzpicture}}
        \subcaptionbox{\(i_1 (K)\)}{
            \begin{tikzpicture}[scale=0.2]
                \draw[thick, red] (22,0) to (27,0) to (27,-6) to (0,-6) -- (1,-6) -- (0,-6) -- (0,0) -- (22,0);
                \filldraw[black] (13.5,-6) circle (5pt) node[anchor=north, yshift=-0.3cm]{\(p\)};
                \draw[dashed, line width=0.6pt] (2,-1) to (2,1) to (-1,1) to (-1,-7) to (28,-7) to (28,1) to (25,1) to (25,-1) to (26,-1) to (26,-5) to (1,-5) to (1,-1) to (2,-1);
                \node at (26.4,2.5) {\(U_p\)};
            \end{tikzpicture}}
        \caption{Bachelors' unknotting demonstrating the isotopy equivalence of a knot with tame arc to the trivial knot. Here we have chosen the point \(r\) (not shown in the figure) to be the midpoint of the knotted region. \(f(a)\) and \(f(b)\) are the intersections of the knot \(K\), represented by the thick red line, with \(U_p\), shown using dashed lines. Note that \(f(a)\), \(r\) and \(f(b)\) are collinear in this case. The entirety of the knot is tame in this case, but we only require tameness in the chosen region of \(U_p \cap K\).}
        \label{fig:bachelor}
    \end{figure}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[scale=1.4]
            ...
            \draw[line width=0.6pt, gray] (-2.5pt,4) node[anchor=east, black]{\(2\pi\)} -- (2.5pt,4);
            \node at (0,-0.2) {\(0\)};
            \node at (4,-0.2) {\(1\)};

            \draw[gray, dotted, line width=0.6pt] (0,2) -- (4,2);
            \draw[gray, dotted, line width=0.6pt] (2,0) -- (2,4);
            \draw[gray, dashed, line width=0.7pt] (2,1.5) -- (0,1.5);
            \draw[gray, dashed, line width=0.7pt] (2,2.5) -- (0,2.5);
            \node at (-0.36,1.5) {\(\phi_t(a)\)};
            \node at (-0.36,2.5) {\(\phi_t(b)\)};
            \node at (-0.6,2) {\((a+b)/2\)};
            \node at (2,-0.2) {\(t\)};
            \draw[thick] (0,1) node[anchor=east]{\(a\)} -- (4,2) -- (0,3) node[anchor=east]{\(b\)};
        \end{tikzpicture}
        \caption{Illustration of shrinkage of domain with respect to \(t\). For all \(t \in [0,1]\), the interval \([\phi_t(a), \phi_t(b)] \in [0,2\pii)\) maps to the shrunk `knotted' part. The images of \([a,\phi_t(a)]\) and \([\phi_t(b),b]\) map to the straight lines which connect \(f(a)\) to \(i_t(f(\phi_t(a)))\) and \(i_t(f(\phi_t(b)))\) to \(f(b)\).}
