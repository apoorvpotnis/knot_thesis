...
\begin{figure}
    \centering
    \begin{tikzpicture}[scale=0.2]
        \begin{knot}[clip width = 9, consider self intersections = true, ignore endpoint intersections = false, use Hobby shortcut]
