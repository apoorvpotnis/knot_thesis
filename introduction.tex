...
\begin{defn}
    A collection of disjoint embeddings of \(\sone\) in a three dimensional space is called a link.
\end{defn}
...
\begin{figure}
    \centering
    \subcaptionbox{An oriented trefoil}{
        \begin{tikzpicture}[
            use Hobby shortcut,
            every trefoil component/.style={thick, draw},
            trefoil component 1/.style={red},
            ...
            decoration={
                markings,
                mark=at position 0.5 with {\arrowreversed{To}}
            }]
            \path[spath/save=trefoil] ([closed]90:2) foreach \k in {1,...,3} {
                .. (-30+\k*240:.5) .. (90+\k*240:2) } (90:2);
            \tikzset{spath/knot={trefoil}{8pt}{1,3,5}}
        \end{tikzpicture}}\quad\quad
    \subcaptionbox{An oriented Hopf link}{
        \begin{tikzpicture}
            \begin{knot}[clip width=7]
...
\begin{figure}
    \centering
    \subcaptionbox{Positive crossing \(+1\)}[3cm]{
        \begin{tikzpicture}
    ...
    \subcaptionbox{Negative crossing \(-1\)}[3cm]{
        \begin{tikzpicture}
            \begin{knot}[clip width = 6]
                \strand[->, thick, red] (1,1) to (0,2);
                \strand[->, thick, red] (0,1) to (1,2);
